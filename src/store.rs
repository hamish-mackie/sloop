...
pub use crate::work_state::local::{
    LocalTicketFile, ProjectRecord, ReindexResult, ReindexStateChange, ReindexTicket, TicketCounts,
    TicketRecord,
};
...
mod tests {
    ...
    use super::{ActivationKind, ClaimRequest, NewActivation, Store, StoreError};
